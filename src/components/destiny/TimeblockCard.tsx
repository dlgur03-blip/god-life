    ...
    <div className={cn(
      ...
      <div className="flex justify-between items-center mb-3">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs text-gray-500">to {block.endTime}</span>
        </div>
      ...
      <div className="space-y-2">
        {mode === 'plan' ? (
          <>
            <div className="flex items-center gap-2">
              <span className="text-xs text-gray-500 w-12">Where</span>
              <DebouncedInput 
            ...
            <div className="flex items-center gap-2">
              <span className="text-xs text-gray-500 w-12">What</span>
              <DebouncedInput 
          ...
          <>
             <div className="flex items-center gap-2">
              <span className="text-xs text-gray-500 w-12">Done</span>
              <DebouncedInput 
            ...
            <div className="flex items-center gap-2">
             ...
             <div className="flex items-center gap-2">
              <span className="text-xs text-gray-500 w-12">Feed</span>
              <DebouncedInput 
