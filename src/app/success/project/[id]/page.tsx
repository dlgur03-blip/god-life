          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
            <div>
              ...
              <div className="flex gap-4 text-sm text-gray-400">
                ...
                <span className="flex items-center gap-1"><Clock className="w-4 h-4" /> Reminder: {project.reminderTime}</span>
              </div>
            </div>
            ...
            <div className="text-right">
              ...
              <div className="text-xs text-gray-500 uppercase tracking-widest">Current Day</div>
            </div>
          </div>
        </header>
