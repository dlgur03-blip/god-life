    ...
    <main className="min-h-screen bg-[url('/bg-grid.svg')] p-6 pb-20">
      <div className="max-w-3xl mx-auto">
        <header className="mb-10 flex items-center justify-between">
           <Link href={`/discipline/day/${todayStr}`} className="text-gray-500 hover:text-white flex items-center gap-2 text-sm w-fit">
        ...
        <div className="space-y-6">
            ...
            <div key={rule.id} className="bg-white/5 border border-white/10 p-6 rounded-2xl">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-black/30 p-4 rounded-xl border border-white/5">
                  ...
                  <div className="text-xs text-gray-500 uppercase tracking-widest">{t('sevenDayRate')}</div>
                ...
                <div className="bg-black/30 p-4 rounded-xl border border-white/5">
                  ...
                  <div className="text-xs text-gray-500 uppercase tracking-widest">{t('thirtyDayRate')}</div>
                   <div className="w-full h-1 bg-white/5 mt-2 rounded-full overflow-hidden">
          ...
          {stats.length === 0 && (
            <div className="text-center py-20 border border-dashed border-white/10 rounded-2xl">
              <p className="text-gray-500">{t('noRulesInsight')}</p>
            </div>
          )}
        </div>
      </div>
