  ...
  return (
    <main className="min-h-screen bg-[url('/bg-grid.svg')] p-6 flex items-center justify-center">
      <div className="w-full max-w-md bg-black/50 backdrop-blur-xl border border-white/10 p-8 rounded-2xl shadow-[0_0_50px_rgba(0,0,0,0.5)]">
        ...
        <h1 className="text-2xl font-bold text-white mb-6">{t('form.title')}</h1>
        
        <form action={createSuccessProject} className="space-y-6">
          <div>
            <label className="block text-xs font-bold text-gray-500 uppercase mb-2">{t('form.projectTitle')}</label>
            <input
              name="title"
              type="text"
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-xs font-bold text-gray-500 uppercase mb-2">{t('form.startDate')}</label>
              <input
                name="startDate"
                type="date"
                required
            ...
            <div>
              <label className="block text-xs font-bold text-gray-500 uppercase mb-2">{t('form.reminderTime')}</label>
              <input
                name="reminderTime"
                type="time"
                defaultValue="09:00"
